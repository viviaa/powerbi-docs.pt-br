...
Agora, o gráfico usa duas medidas: SalesAmount, que foi somada automaticamente, e Net Sales, que você criou. Cada medida foi calculada no contexto de outro campo, RegionCountryName.
