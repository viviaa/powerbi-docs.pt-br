...
> [!NOTE]
> Atualmente, os modelos criados usando a interface visual do Serviço do Azure Machine Learning (versão prévia) não dão suporte à geração de esquema, mas darão nas versões seguintes. 
