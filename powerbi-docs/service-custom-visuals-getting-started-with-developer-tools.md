...
## <a name="enable-a-live-preview-of-the-developer-visual"></a>Habilitar uma visualização dinâmica do visual do desenvolvedor
...
![Seleção visual do desenvolvedor do Power BI](media/service-custom-visuals-getting-started-with-developer-tools/powerbi-developer-visual-selection.png)
