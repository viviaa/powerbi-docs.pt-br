...
Você também pode [exibir relatórios locais do Power BI, relatórios móveis do Reporting Services e KPIs com os aplicativos móveis do Power BI](mobile/mobile-app-ssrs-kpis-mobile-on-premises-reports.md).
...
* [Pacotes de conteúdo para serviços](end-user-connect-to-services.md), com dashboards, relatórios e conjuntos de dados prontos para serviços como o Salesforce. Além de estabelecer uma conexão de dados, o Power BI fornece relatórios e painéis pré-criados para cada um desses serviços.
...
Veja uma lista completa de [navegadores com suporte para o Power BI](end-user-browsers.md).
