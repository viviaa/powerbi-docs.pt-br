...
Este artigo oferece uma visão mais detalhada do painel Filtros do relatório. Você verá o painel no [Modo de Exibição de Edição e no Modo de Exibição de Leitura do serviço Power BI](end-user-reading-view.md) e no [Modo de Exibição de Relatório do Power BI Desktop](../desktop-report-view.md).
...
[Interação com os filtros e realce no relatório de exibição de leitura](end-user-reading-view.md)  
[Criar filtros no Modo de exibição de edição do relatório](../power-bi-report-add-filter.md)  
[Alterar como elementos visuais de relatórios executam filtro cruzado e realce cruzado entre si](end-user-interactions.md)
