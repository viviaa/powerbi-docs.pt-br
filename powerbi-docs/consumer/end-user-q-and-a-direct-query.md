...
* [Introdução a P e R do Power BI](end-user-q-and-a.md)
...
1. No canto superior direito do Power BI, selecione o ícone de engrenagem ![ícone de engrenagem](./media/end-user-q-and-a-direct-query/power-bi-cog.png) e escolha **Configurações**.
   
   ![Menu Configurações](./media/end-user-q-and-a-direct-query/powerbi-settings.png)
2. Selecione **conjuntos de dados** e escolha o conjunto de dados que será habilitado para a P e R.
   
   ![Tela de conjuntos de dados do menu Configurações](./media/end-user-q-and-a-direct-query/power-bi-q-and-a-settings.png)
3. Expanda **P e R e Cortana**, marque a caixa de seleção **Ativar P e R neste conjunto de dados** e escolha **Aplicar**.
   
    ![Área expandida de P e R](./media/end-user-q-and-a-direct-query/power-bi-q-and-a-directquery.png)
...
[Visão geral de P e R do Power BI](end-user-q-and-a.md)  
