...
2. Localize o dashboard a ser excluído e selecione o ícone Excluir ![ícone excluir](./media/end-user-delete/power-bi-delete-icon.png).
...
2. Localize o relatório a ser excluído e selecione o ícone Excluir   ![ícone excluir](./media/end-user-delete/power-bi-delete-icon.png).   

    ![guia relatórios do espaço de trabalho](./media/end-user-delete/power-bi-delete-reportnew.png)
3. Confirme a exclusão.

   ![Caixa de diálogo Excluir relatório](./media/end-user-delete/power-bi-delete-report.png)
...
2. Localize a pasta de trabalho a ser excluída e selecione o ícone ![ícone excluir](./media/end-user-delete/power-bi-delete-report2.png) Excluir.

    ![Guia Pastas de trabalho](./media/end-user-delete/power-bi-delete-workbooknew.png)
3. Confirme a exclusão.

   ![Caixa de diálogo Remover pasta de trabalho](./media/end-user-delete/power-bi-delete-confirm.png)
...
2. Localize o conjunto de dados para excluir e selecione as reticências (...).  
    ...
    ![Guia Conjuntos de dados](./media/end-user-delete/power-bi-delete-datasetnew.png)
3. No menu suspenso, selecione **Excluir**.

   ![menu de reticências](./media/end-user-delete/power-bi-delete-datasetnew2.png)
4. Confirme a exclusão.

   ![Caixa de diálogo Excluir dashboard](./media/end-user-delete/power-bi-delete-dataset-confirm.png)
...
1. No menu de navegação à esquerda, selecione **Espaços de trabalho**
    ...
    ![Espaços de trabalho de aplicativo](./media/end-user-delete/power-bi-delete-workspace.png)
2. Selecione as reticências (...) à direita do espaço de trabalho a ser excluída e escolha **Editar espaço de trabalho**.

   ![menu de reticências > Editar espaço de trabalho](./media/end-user-delete/power-bi-edit-workspace.png)
3. Na janela **Editar espaço de trabalho**, selecione **Excluir espaço de trabalho** > **Excluir**.

    ![excluir espaço de trabalho](./media/end-user-delete/power-bi-delete-workspace2.png)
...
2. No canto superior direito, selecione as reticências (...) e escolha **Sair do espaço de trabalho** > **Sair**.
      ...
      ![sair do espaço de trabalho](./media/end-user-delete/power-bi-leave-workspace.png)
...
2. Passe o mouse sobre o aplicativo a ser excluído e selecione o ícone Excluir ![](./media/end-user-delete/power-bi-delete-report2.png).

   ![selecionar Aplicativos](./media/end-user-delete/power-bi-delete-app.png)

   Se você remover um aplicativo acidentalmente, você terá várias opções para obtê-lo novamente.  Você pode solicitar ao criador do aplicativo para enviá-lo novamente, pode encontrar o email original com o link para o aplicativo, pode verificar seu [Centro de Notificações](end-user-notification-center.md) para ver se a notificação desse aplicativo ainda está listada ou pode verificar o [AppSource](end-user-apps.md) da sua organização.
...
* [Remover seu Dashboard em destaque](end-user-featured.md#change-the-featured-dashboard)
* [Remover (dos favoritos) um dashboard](end-user-favorite.md)
* [Excluir uma página de relatório](end-user-delete.md)
* [Excluir um bloco de dashboard](../service-dashboard-edit-tile.md)
* [Excluir uma visualização de relatório](end-user-delete.md)
