...
**account (conta)** Existem diferentes tipos de contas do Power BI.  Uma conta do Power BI Pro é uma assinatura mensal paga.  Uma conta gratuita do Power BI permite exibir o conteúdo que está hospedado na capacidade do Power BI Premium.  
...
**aggregates (agregação)** Quando os valores de várias linhas são agrupados como entrada em critérios para formar um único valor de sentido ou medida mais significativos.
...
**Cortana answer card (cartão de respostas da Cortana)** A página de relatório dedicada para incluir em um relatório do Power BI para poder criar respostas personalizadas da Cortana.

**Cortana answer page (página de respostas da Cortana)** O nome da página da Cortana que é mostrada para o cliente.
...
**Desktop (Área de trabalho)** Primeira instância: Power BI Desktop Menções subsequentes: Área de trabalho
...
**drill up, drill down, drillthrough (fazer drill up, fazer drill down, detalhamento)**
...
**environment (ambiente)** [Power BI Desktop, Power BI Mobile, etc.] Use ambiente do Power BI. Para clientes multilocatários, use esse termo para se referir-se à escolha de qual locatário se conectar.
...
**focus mode (modo de foco)** [serviço do Power BI]

**Free account (Conta gratuita)** Consulte conta nesta coleção de termos

**full screen, full-screen mode (tela inteira, modo de tela inteira)** [serviço do Power BI]
...
**page (página)** Relatórios têm uma ou mais páginas. Cada guia na parte inferior da tela do relatório representa uma página.
...
**pin, unpin (fixar, desafixar)** A ação de colocar um visual, geralmente de um relatório, em um dashboard.
...
**report editor (editor de relatório)**
...
**report server (servidor de relatório)** Uma instância de um servidor de relatório.
...
**service (serviço)** Consulte *serviço do Power BI*
...
**Visualizations pane (Painel de visualizações)** Nome para os modelos de visualização que são fornecidos na tela de relatório compartilhada para Power BI Desktop e o serviço do Power BI. Contém os modelos pequenos, também chamados de ícones, para cada tipo de visualização nativa.  
