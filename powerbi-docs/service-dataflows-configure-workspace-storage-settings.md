...
description: Configurar um espaço de trabalho do aplicativo no Power BI para armazenar sua definição de fluxo de dados e arquivos de dados no Azure Data Lake Storage Gen2
