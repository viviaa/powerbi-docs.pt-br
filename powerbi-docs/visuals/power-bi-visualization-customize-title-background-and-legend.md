...
Avance até 4:50 no vídeo para ver uma demonstração de como personalizar as visualizações. Em seguida, siga as instruções abaixo do vídeo para experimentar por conta própria com seus dados.
